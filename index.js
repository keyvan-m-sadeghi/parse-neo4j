...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(58), __webpack_require__(61)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	    ...
	    var _marked = [keyValues, enumerate].map(_regenerator2.default.mark);
	    ...
	    const hasProperties = function (obj) {
	        return obj.properties && obj.identity && obj.identity.low;
	    };
	        ...
	        if (!record || typeof record !== 'object') return record;else
	            ...
	            if (Object.keys(record).length === 2 && typeof record.low === 'number' && typeof record.high === 'number') {
	                ...
	                // If it's an array
	                    ...
	                    try {
	                        for (var _iterator3 = record[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                            let current = _step3.value;
	                    ...
	                    try {
	                        for (var _iterator4 = keyValues(properties)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	                            var _step4$value = (0, _slicedToArray3.default)(_step4.value, 2);
	
	                            let key = _step4$value[0],
	    ...
	    const parseNeo4jResponse = function (response) {
	        ...
	        try {
	            for (var _iterator5 = response.records[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	                const record = _step5.value;
	                ...
	                if (record.length == 1) result.push(parseRecord(record._fields[0]));else {
	                    ...
	                    try {
	                        for (var _iterator6 = enumerate(record.keys)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	                            var _step6$value = (0, _slicedToArray3.default)(_step6.value, 2);
	
	                            const index = _step6$value[0],
	                                  key = _step6$value[1];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
	    ...
	    exports.to64BitsIntegerString = to64BitsIntegerString;
	});
